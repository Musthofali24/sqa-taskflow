#!/usr/bin/env python3
"""Script untuk menjalankan semua automation tests TaskFlow"""
...
def main():
    ...
    frontend_passed = run_command(
        "cd tests/selenium && pytest test_frontend.py -v "
        "--html=../../reports/frontend-test-report.html --self-contained-html",
    ...
    print(f"{'='*60}")
    print(
        f"Overall Result:     {'✅ ALL PASSED' if all_passed else '❌ SOME TESTS FAILED'}"
    )
